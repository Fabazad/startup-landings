        ...
        <Dialog fullWidth maxWidth="xs" fullScreen={isMobile} open={open} onClose={onClose} >
            ...
            <DialogContent sx={{ py: 5 }}>
                <WishListList wishLists={wishLists} isLoading={isLoading} emptyContent={{
                    ...
                    button: { title: "Créer votre première liste d'envie", href: paths.envy.wishList.create }
                }} href={(listId) => paths.envy.wishList.addWish(listId)} />
                {!isLoading && (wishLists?.length || 0) > 0 && (<>
                    ...
                    <Link href={paths.envy.wishList.create} style={{ width: '100%' }}>
