...
export function HomeHero({ sx, ...other }: BoxProps) {
  ...
  const renderHeading = (
    <AnimatedDiv>
      ...
      >
        ...
        >
          Avant qu’ils ne vous dépassent
        </Box>
      </Box>
    </AnimatedDiv>
  );
  ...
  const renderText = (
    <AnimatedDiv>
      ...
      >
        {`InsightFeed utilise l’IA pour détecter automatiquement vos concurrents SaaS\net vous alerte en temps réel sur leurs évolutions stratégiques (landing, prix, features, pubs…).`}
      </Typography>
    </AnimatedDiv>
  );
